...
extractor = Extractor()
documents = extractor.content_extractor(r"documents/Principal-Sample-Life-Insurance-Policy.pdf")
print(type(documents))
text_chunking = TextChunking()
chunks = text_chunking.create_chunks(documents)

id = 0
for id, ch in enumerate(chunks):
    print(f"Chunk: {id}", ch, end="\n\n")
print(id)
